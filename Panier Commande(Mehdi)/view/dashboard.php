                            ...
                            <div class="recentorders">
                                <div class="recentorders">
                                    <div class="cardheader">
                                        <h2>voitures</h2>
                                        <a href="addCommande.php" class="btn">Ajouter</a>
                                    </div>
                                    <table>
                                    ...
                                    <tbody>
                                    <?php
                foreach($listevoitures as $commande) {
             ?>
                                        <tr>
                                           <td> <?php echo $commande['idcommande']; ?></td>
                                           <td> <?php echo $commande['nom_voiture']; ?></td>
                                           ...
                                           <td>
                                            <form method="post" action="deleteCommande.php">
						                     ...
						                     <input type="hidden" value=<?PHP echo $commande['idcommande']; ?> name="id">
					                        </form>
                                          </td>
                                ...
                                <form method="post" action="dashboard.php">
						                     <input type="submit" class="button" name="catergorie" value="categorie">
					                        </form>
