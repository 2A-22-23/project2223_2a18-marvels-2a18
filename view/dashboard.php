                    ...
                    <div class="recentorders">
                        <div class="recentorders">
                            <div class="cardheader">
                                <h2>pieces</h2>
                                <a href="addpiece.php" class="btn">Ajouter</a>
                            </div>
                            <table>
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <tr>
                                        <td> <?php echo $piece['idpiece']; ?></td>
                                        <td> <?php echo $piece['nompiece']; ?></td>
                                        ...
                                        <td align="center">
                                            <form method="POST" action="updatepiece.php">
                                                <input type="submit" name="update" value="Update" class="btn modif">
                                                <input type="hidden" value=<?PHP echo $piece['idpiece']; ?> name="idpiece">
                                            </form>
                                        </td>
                                        <td> 
                                            <a class="btn supp" href="deletepiece.php?idpiece=<?php echo $piece['idpiece']; ?>">Delete</a>
                                        </td>
                                    </tr>
                                    <?php
                                        }
