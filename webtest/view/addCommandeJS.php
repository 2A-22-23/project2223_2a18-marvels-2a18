...
if (
    ...
    if (
      /*   !empty($_POST['idcommande']) && */
        ...
        $voiture = new commande(null,$_POST['addresse'],$_POST['date'],$_POST['idpiece'],0,0); 
...
<body>
    ...
    <form name='myForm' action="" method="POST" name='inscription-form' onsubmit = "return(validate());">
       ...
       <!--  <tr>
            ...
            <tr>
                                        <td>
                                            <label class="txt" for="idpiece">piece: </label>
                                        </td>
                                        <td>
                                            <select name="idpiece" id="idpiece">
                                                <?php foreach ($l as $piece ){?>
                                                    <option value="<?= $piece['idpiece']?>"><?= $piece['nompiece']?></option>
                                                <?php }?>
                                            </select>
                                        </td>
                                    </tr>
