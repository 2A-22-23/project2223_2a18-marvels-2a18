...
if (
    ...
    if (
      /*   !empty($_POST['idcommande']) && */
        ...
        $voiture = new commande(null,$_POST['addresse'],$_POST['date'],0,$_POST["idvoiture"],0); 
...
<body>
    ...
    <form name='myForm' action="" method="POST" name='inscription-form' onsubmit = "return(validate());">
       ...
       <!--  <tr>
            ...
            <tr>
                                        <td>
                                            <label class="txt" for="idpiece">Voiture: </label>
                                        </td>
                                        <td>
                                            <select name="idvoiture" id="idvoiture">
                                                <?php foreach ($l as $piece ){?>
                                                    <option value="<?= $piece['idvoiture']?>"><?= $piece['nom_voiture']?></option>
                                                <?php }?>
                                            </select>
                                        </td>
                                    </tr>
