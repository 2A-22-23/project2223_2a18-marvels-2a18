...
<div class="container" style="width:600px;">
  ...
  <nav class="navbar navbar-inverse" style="background:#04B745;">
    ...
    <div class="pull-right" style="margin-top:7px;margin-right:7px;"><a href="sheet.php?action=emptyall" class="btn btn-info">Empty cart</a></div>
  </nav>
  <table class="table table-striped">
    ...
    <tr>
      ...
      <td>dt<?php print $product['price']?></td>
      <td><?php print $product['qty']?></td>
      <td><a href="sheet.php?action=empty&sku=<?php print $key?>" class="btn btn-info">Delete</a></td>
    </tr>
      ...
      <div class="col-md-4">
        <div class="thumbnail"> <img src="<?php print $product['image']?>" alt="Lights">
          <div class="caption">
            ...
            <p style="text-align:center;color:#04B745;"><b><?php print $product['price']?> dt</b></p>
            <form method="post" action="sheet.php?action=addcart">
