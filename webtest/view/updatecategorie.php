        ...
        <form action="" method="POST">
            <table border="1" align="center">
                <tr>
                    ...
                    <td bgcolor=#287bff><input type="text" name="idcategorie" id="idcategorie" value="<?php echo $categorie['idcategorie']; ?>" maxlength="30"></td>
                </tr>
                <tr>
                    <td bgcolor=#287bff>
                    ...
                    <td bgcolor=#287bff><input type="text" name="nom_categorie" id="nom_categorie" value="<?php echo $categorie['nom_categorie']; ?>" maxlength="30"></td>
                </tr>
                
                <tr>
                    <td bgcolor=#287bff>
                        <label for="nbval">nbval:
                        </label>
                    </td>
                    <td bgcolor=#287bff><input type="text" name="nbval" id="nbval" value="<?php echo $categorie['nbval']; ?>" maxlength="30"></td>
                </tr>
